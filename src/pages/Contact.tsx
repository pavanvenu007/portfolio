      ...
      <div className="max-w-7xl mx-auto">
        <ScrollReveal>
          <div className="mb-24">
            ...
            <h1 className="text-7xl font-bold tracking-tighter text-white uppercase">CONTACT.</h1>
          </div>
        </ScrollReveal>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-5">
            <ScrollReveal direction="left">
              <div className="p-12 theme-card bg-neutral-900/50">
                <h2 className="text-2xl font-bold tracking-tighter text-white mb-12 uppercase italic">Registry</h2>
                <div className="space-y-12">
                  <div className="flex gap-8 group">
                    ...
                    <div>
                      ...
                      <a href="mailto:pavanvenu007@gmail.com" className="text-white text-lg font-bold tracking-tight hover:text-primary-500 transition-colors lowercase">
                  ...
                  <div className="flex gap-8 group">
                    ...
                    <div>
                      ...
                      <a href="https://wa.me/919972914067" target="_blank" rel="noopener noreferrer" className="text-white text-lg font-bold tracking-tight hover:text-primary-500 transition-colors">
                        +91 99729 14067
                      </a>
                    </div>
                  </div>
          ...
          <div className="lg:col-span-7">
            <ScrollReveal direction="right">
              <div className="p-12 theme-card">
                <h2 className="text-2xl font-bold tracking-tighter text-white mb-10 uppercase italic">Transmission</h2>
                <form className="space-y-10" onSubmit={(e) => e.preventDefault()}>
                    ...
                    <div className="space-y-3">
                      ...
                      <input 
                        type="text" 
                        placeholder="NAME"
                        className="w-full bg-neutral-950 border border-neutral-800 rounded-xl py-5 px-6 text-white text-xs font-bold uppercase tracking-widest focus:outline-none focus:border-primary-500 transition-colors"
                      />
                    </div>
                    <div className="space-y-3">
                  ...
                  <div className="space-y-3">
                    ...
                    <textarea 
                      ...
                      className="w-full bg-neutral-950 border border-neutral-800 rounded-3xl py-5 px-6 text-white text-xs font-bold uppercase tracking-widest focus:outline-none focus:border-primary-500 transition-colors resize-none"
                    ></textarea>
                  </div>

                  <button 
                    type="submit"
                    className="w-full py-6 bg-white text-neutral-950 font-black text-xs uppercase tracking-[0.4em] hover:bg-primary-600 hover:text-white rounded-full transition-all flex items-center justify-center gap-4 group"
                  >
                    Send Signal
