    ...
    <div className="pt-20" ref={containerRef}>
      ...
      <section className="relative min-h-[90vh] flex items-center px-10 overflow-hidden">
        <motion.div 
          ...
          className="max-w-7xl mx-auto w-full grid grid-cols-12 gap-8 items-center"
        >
          <motion.div
          ...
          >
            ...
            <h1 className="text-7xl md:text-8xl lg:text-[120px] font-bold leading-[0.85] tracking-tighter text-white mb-10 flex flex-col">
              <span>PAVAN</span>
              <span className="text-neutral-500">VENUGOPAL</span>
            </h1>
            
            <p className="text-neutral-400 text-sm md:text-base max-w-[320px] mb-12 leading-relaxed">
            ...
            <div className="flex flex-wrap gap-2 mb-12">
              {['Python', 'JavaScript', 'C++', 'Databases'].map(skill => (
                <span key={skill} className="px-4 py-1.5 bg-neutral-900 border border-neutral-800 text-[10px] uppercase font-bold tracking-widest text-neutral-300 rounded-full">
                  {skill}
                </span>
              ))}
            </div>
          ...
          >
            <div className="p-8 theme-card relative overflow-hidden group h-[500px] flex flex-col justify-end">
              ...
              <div className="relative z-10">
                <p className="micro-label text-primary-400 mb-2 italic">Featured Focus</p>
                <h3 className="text-4xl font-bold mb-4">TALOS AI</h3>
      ...
      <section className="py-32 px-10 border-t border-neutral-800 bg-neutral-900/10">
                ...
                <ScrollReveal delay={i * 0.1}>
                  <div className="group h-full">
                    <div className="flex items-center gap-4 mb-6">
                      ...
                      <h3 className="text-sm font-bold uppercase tracking-widest text-white">{skill.name}</h3>
                    </div>
