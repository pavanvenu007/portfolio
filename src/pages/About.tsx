      ...
      <div className="max-w-7xl mx-auto">
        <ScrollReveal>
          <div className="grid grid-cols-1 md:grid-cols-12 gap-16 items-start mb-32">
            <div className="md:col-span-7">
              <h1 className="text-7xl md:text-8xl font-bold leading-[0.85] tracking-tighter text-white mb-10">
                DRIVEN BY<br/><span className="text-neutral-500">CURIOSITY.</span>
              </h1>
              <div className="space-y-6 text-neutral-400 text-sm md:text-base leading-relaxed max-w-xl">
                <p>
                  I'm <span className="text-white font-bold tracking-tight">Pavan Venugopal</span>, a BCA & AI/ML student merging computer science fundamentals with modern web architecture. My focus lies at the intersection of machine learning, high-performance code, and intelligent system design.
                </p>
                <p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
          <ScrollReveal direction="left">
            <h2 className="text-3xl font-bold tracking-tighter mb-10 border-b border-neutral-800 pb-4">CORE EXPERTISE</h2>
            <div className="space-y-4">
              {[
                ...
                <div key={item.skill} className="p-6 theme-card group hover:bg-neutral-800/50 transition-all">
                  <h3 className="text-white font-bold text-sm uppercase tracking-widest mb-2 flex items-center gap-3">
          ...
          <ScrollReveal direction="right">
            <h2 className="text-3xl font-bold tracking-tighter mb-10 border-b border-neutral-800 pb-4">MILESTONES</h2>
            <div className="space-y-10">
              {[
                ...
                <div key={milestone.title} className="flex gap-8 group">
                  <div className="text-2xl font-black text-neutral-800 group-hover:text-primary-500 transition-colors tracking-tighter self-start italic">{milestone.year}</div>
                  <div>
                    <h3 className="text-white font-bold text-sm uppercase tracking-widest mb-2">{milestone.title}</h3>
