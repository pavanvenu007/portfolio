      ...
      <div className="max-w-7xl mx-auto">
        <ScrollReveal>
          <div className="mb-24">
            ...
            <h1 className="text-7xl font-bold tracking-tighter text-white">SERVICES.</h1>
          </div>
        </ScrollReveal>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-neutral-800 border border-neutral-800 mb-32 overflow-hidden rounded-[2rem]">
          {services.map((service, i) => (
            <div key={service.title} className="bg-neutral-950 p-12 hover:bg-neutral-900 transition-colors group">
                ...
                <div className="flex flex-col h-full">
                  ...
                  <div className="mt-auto space-y-3">
                    {service.features.map(feature => (
                      <div key={feature} className="flex items-center gap-3 text-neutral-400 text-[10px] font-bold uppercase tracking-widest">
        ...
        <ScrollReveal>
          <div className="flex flex-wrap justify-between items-center gap-12 py-20 border-t border-neutral-800">
            {[
              ...
              <div key={benefit.title} className="flex gap-4">
                ...
                <div>
                  <h4 className="text-white text-xs font-black tracking-widest uppercase mb-1">{benefit.title}</h4>
        ...
        <ScrollReveal>
          <div className="mt-32 p-20 theme-card text-center bg-neutral-900/10 border-dashed">
            <h2 className="text-5xl font-bold tracking-tighter text-white mb-8 italic">SCALE YOUR INFRASTRUCTURE</h2>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-8">
              <a href="/contact" className="px-10 py-4 bg-primary-600 text-white font-black text-xs uppercase tracking-widest hover:bg-primary-500 transition-all flex items-center justify-center gap-3">
                Request Brief <ArrowRight size={16} />
              </a>
              <a href="/projects" className="text-xs font-black uppercase tracking-widest text-neutral-500 hover:text-white transition-colors flex items-center gap-2">
                Browse Archive
              </a>
            </div>
          </div>
